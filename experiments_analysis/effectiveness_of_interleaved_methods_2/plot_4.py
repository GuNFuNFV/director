...
if __name__ == "__main__":
    ...
    for i in df1.values[21: 28]:
        temp_list = eval(i[2])[:5]
        packet_size = packet_size_list[i[0] - 21]
    ...
    plt.plot(packet_size_list, representative_interleaved_throughput, label="interleaved", color="orange", marker="^")
    plt.plot(packet_size_list, representative_rtc_throughput, label="monolithic", color="blue", marker="o")
    ...
    #                  yerr=np.std(temp_interleaved_throughput), fmt="^", color="orange")
